  ...
  <body>
      ...
      <div class="page-main-header">
        <div class="main-header-right row">
          <div class="main-header-left d-lg-none">
            <div class="logo-wrapper"><a href="index.html"><img src="{{ asset("img/logo.png") }}" alt=""></a></div>
          </div>
        ...
        <div class="page-sidebar">
          ...
          <div class="sidebar custom-scrollbar">
            <div class="sidebar-user text-center">
              <div><img style="width: 85px" class="rounded-circle" src="{{ asset("img/logo.png") }}" alt="#">
            ...
            <ul class="sidebar-menu">
              <li><a class="sidebar-header" href="{{ url('home') }}"><i data-feather="home"></i><span>Dashboard</span></a>
              ...
              <li><a class="sidebar-header" href="#"><i data-feather="home"></i><span>Roles</span><i class="fa fa-angle-right pull-right"></i></a>
                <ul class="sidebar-submenu">
                  <li><a href="{{ url('role/group-create') }}"><i class="fa fa-circle"></i><span>Add Group Role</span></a></li>
                  <li><a href="{{ url('role/create') }}"><i class="fa fa-circle"></i><span>Add Role</span></a></li>
                  <li><a href="{{ url('role/all') }}"><i class="fa fa-circle"></i><span>View Roles</span></a></li>
                </ul>
              </li>
              <li><a class="sidebar-header" href="#"><i data-feather="home"></i><span>Users</span><i class="fa fa-angle-right pull-right"></i></a>
                <ul class="sidebar-submenu">
                  <li><a href="{{ url('user/create') }}"><i class="fa fa-circle"></i><span>Add User</span></a></li>
                  <li><a href="{{ url('user/all') }}"><i class="fa fa-circle"></i><span>All Users</span></a></li>
                </ul>
              </li>
              <li><a class="sidebar-header" href="#"><i data-feather="home"></i><span>Question</span><i class="fa fa-angle-right pull-right"></i></a>
                <ul class="sidebar-submenu">
                  <li><a href="{{ url('Question/create') }}"><i class="fa fa-circle"></i><span>Add Question</span></a></li>
                  <li><a href="{{ url('Question/all/0') }}"><i class="fa fa-circle"></i><span>View Entrepreneur Question</span></a></li>
                  <li><a href="{{ url('Question/all/1') }}"><i class="fa fa-circle"></i><span>View Investor Question</span></a></li>
                </ul>
              </li>
              <li><a class="sidebar-header" href="#"><i data-feather="home"></i><span>Question Categories</span><i class="fa fa-angle-right pull-right"></i></a>
                <ul class="sidebar-submenu">
                  <li><a href="{{ url('question-category/create') }}"><i class="fa fa-circle"></i><span>Add Category</span></a></li>
                  <li><a href="{{ url('question-category/0/all') }}"><i class="fa fa-circle"></i><span>View Entrepreneur Category</span></a></li>
                  <li><a href="{{ url('question-category/1/all') }}"><i class="fa fa-circle"></i><span>View Investor Category</span></a></li>
                </ul>
              </li>
              <li><a class="sidebar-header" href="#"><i data-feather="home"></i><span>Application</span><i class="fa fa-angle-right pull-right"></i></a>
                <ul class="sidebar-submenu">
                  <li><a href="{{ url('answer/all/0') }}"><i class="fa fa-circle"></i><span>Entrepreneur Application</span></a></li>
                  <li><a href="{{ url('answer/all/1') }}"><i class="fa fa-circle"></i><span>Investor Application</span></a></li>
                </ul>
              </li>
              <li><a class="sidebar-header" href="#"><i data-feather="home"></i><span>Service Sector</span><i class="fa fa-angle-right pull-right"></i></a>
                <ul class="sidebar-submenu">
                  <li><a href="{{ url('service-sector/create') }}"><i class="fa fa-circle"></i><span>Add Service Sector</span></a></li>
                  <li><a href="{{ url('service-sector/all') }}"><i class="fa fa-circle"></i><span>View Service Sector</span></a></li>
                </ul>
              </li>

              <li><a class="sidebar-header" href="{{ url('onboarding-status/create') }}"><i data-feather="home"></i><span>Onboarding Status</span></a>
              </li>

              <li><a class="sidebar-header" href="#"><i data-feather="home"></i><span>Membership Plan</span><i class="fa fa-angle-right pull-right"></i></a>
                <ul class="sidebar-submenu">
                  <li><a href="{{ url('membership-plane/create') }}"><i class="fa fa-circle"></i><span>Add Plan</span></a></li>
                  <li><a href="{{ url('membership-plane/all') }}"><i class="fa fa-circle"></i><span>View Plan</span></a></li>
                </ul>
              </li>


              <li><a class="sidebar-header" href="#"><i data-feather="home"></i><span>Email Events</span><i class="fa fa-angle-right pull-right"></i></a>
                <ul class="sidebar-submenu">
                  <li><a href="{{ url('email-event/create') }}"><i class="fa fa-circle"></i><span>Add Event</span></a></li>
                  <li><a href="{{ url('email-event/all') }}"><i class="fa fa-circle"></i><span>View Events</span></a></li>
                </ul>
              </li>

              <li><a class="sidebar-header" href="#"><i data-feather="home"></i><span>Email User Group</span><i class="fa fa-angle-right pull-right"></i></a>
                <ul class="sidebar-submenu">
                  <li><a href="{{ url('email-user-group/create') }}"><i class="fa fa-circle"></i><span>Add Group</span></a></li>
                  <li><a href="{{ url('email-user-group/all') }}"><i class="fa fa-circle"></i><span>View Group</span></a></li>
                </ul>
              </li>

              <li><a class="sidebar-header" href="#"><i data-feather="home"></i><span>Email Template</span><i class="fa fa-angle-right pull-right"></i></a>
                <ul class="sidebar-submenu">
                  <li><a href="{{ url('email-temp/create') }}"><i class="fa fa-circle"></i><span>Add Template</span></a></li>
                  <li><a href="{{ url('email-temp/all') }}"><i class="fa fa-circle"></i><span>View Template</span></a></li>
                </ul>
              </li>

              <li><a class="sidebar-header" href="#"><i data-feather="home"></i><span>Assign Email Template</span><i class="fa fa-angle-right pull-right"></i></a>
                <ul class="sidebar-submenu">
                  <li><a href="{{ url('assign-email/create') }}"><i class="fa fa-circle"></i><span>Assign Template</span></a></li>
                  <li><a href="{{ url('assign-email/all') }}"><i class="fa fa-circle"></i><span>View Assign Template</span></a></li>
                </ul>
              </li>
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-6 footer-copyright">
                <p class="mb-0">Copyright 2018 © BLIG rights reserved.</p>
              </div>
              <div class="col-md-6">
              </div>
            </div>
    ...
    <script type="text/javascript">
      @if( Session::get('error') )
        setTimeout(function() {
          salert('warning','{{ Session::get('error') }}');
        },1000);
      @endif
      ...
      @if( Session::get('danger') )
        setTimeout(function() {
          salert('error','{{ Session::get('danger') }}');
        },1000);
      @endif
    </script>
    @yield('jquery')
...
<!-- Mirrored from admin.pixelstrap.com/endless/ltr/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Apr 2020 18:15:47 GMT -->
</html>