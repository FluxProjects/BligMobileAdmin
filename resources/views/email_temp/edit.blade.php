...
@endsection
@section('content')
<form method="post" action="{{ url("email-temp/update") }}/{{ $id }}">
  {{ csrf_field() }}
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-4 mb-3">
                ...
                <input class="alhpabet_validation form-control" id="validationDefault01" name="temp_name" type="text" value="{{ $data->name }}" placeholder="Template name" required="">
              </div>

              <div class="col-md-4 mb-3">
                <label for="validationDefault01">Subject</label><span style="color:red">*</span><span style="color:red" class="v_error"></span>
                <input class="alhpabet_validation form-control" id="validationDefault01" name="subject" type="text" value="{{ $data->subject }}" placeholder="Subject" required="">
              </div>
              ...
              <div class="col-md-4 mb-3">
                ...
                <select class="custom-select" name="_event">
                  ...
                  <option {{ $data->event_id==$e->id ? 'selected' : '' }} value="{{ $e->id }}">{{ $e->name }}</option>
                  @endforeach
                </select>
              </div>
              ...
              <div class="col-12 mb-3">
                ...
                <textarea name="_temp">{{ json_decode($data->desc,true) }}</textarea>
              </div>
            </div>
