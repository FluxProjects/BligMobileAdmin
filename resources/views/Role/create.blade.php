          ...
          <div class="card-body">
              ...
              <div class="form-group row mb-5">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   ...
                   <input type="checkbox" name="" id="check-allUser">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkUser" id="Add-User" value="2">
               <label class="checkbox-inline mb-0" for="checkboxes-1">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkUser" id="All-User" value="3">
               <label class="checkbox-inline mb-0" for="All-User">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkUser" id="ViewSingle-User" value="4">
                ...
                <div class="col-12 col-md-6 col-lg-3 mt-2">
                   <input type="checkbox" name="permission[]" class="checkUser" id="DeleteSingle-User" value="5">
              ...
              <div class="form-group row mb-5">
               ...
               <label class="checkbox-inline mb-0" for="checkboxes-0">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkRole" id="Add-Role" value="6">
               <label class="checkbox-inline mb-0" for="Add-Role">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkRole" id="All-Role" value="7">
               <label class="checkbox-inline mb-0" for="All-Role">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                  <input type="checkbox" name="permission[]" class="checkRole" id="Edit-Role" value="10">
               <label class="checkbox-inline mb-0" for="Edit-Role">
                ...
                <div class="col-12 col-lg-6 col-lg-3">                        
                   <input type="checkbox" name="permission[]" class="checkRole" id="ViewSingle-Role" value="8">
               <label class="checkbox-inline mb-0" for="ViewSingle-Role">
                 ...
                 <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkRole" id="Delete-Role" value="9">
              ...
              <div class="form-group row mb-5">
               ...
               <label class="checkbox-inline mb-0" for="checkboxes-0">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkCategory" id="Add-Question" value="11">
               <label class="checkbox-inline mb-0" for="Add-Question">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkCategory" id="All-Question" value="12">
               <label class="checkbox-inline mb-0" for="All-Question">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                  <input type="checkbox" name="permission[]" class="checkCategory" id="Edit-Question" value="15">
               <label class="checkbox-inline mb-0" for="Edit-Question">
                ...
                <div class="col-12 col-lg-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkCategory" id="ViewSingle-Question" value="13">
               <label class="checkbox-inline mb-0" for="ViewSingle-Question">
                         View Single Categories
                  </label> 
                </div>
                 <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkCategory" id="Delete-Question" value="14">
              ...
              <div class="form-group row mb-5">
               ...
               <label class="checkbox-inline mb-0" for="checkboxes-0">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkQuestions" id="Add-Question" value="48">
               <label class="checkbox-inline mb-0" for="Add-Question">
                         Add Question
                  </label> 
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkQuestions" id="All-Question" value="49">
               <label class="checkbox-inline mb-0" for="All-Question">
                         All Question
                  </label> 
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                  <input type="checkbox" name="permission[]" class="checkQuestions" id="Edit-Question" value="50">
               <label class="checkbox-inline mb-0" for="Edit-Question">
                         Edit Question
                  </label> 
                </div>
              ...
              <div class="form-group row mb-5">
               ...
               <label class="checkbox-inline mb-0" for="checkboxes-0">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkSerSec" id="Add-ServiceSector" value="16">
               <label class="checkbox-inline mb-0" for="Add-ServiceSector">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkSerSec" id="All-ServiceSector" value="17">
               <label class="checkbox-inline mb-0" for="All-ServiceSector">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                  <input type="checkbox" name="permission[]" class="checkSerSec" id="Edit-ServiceSector" value="20">
               <label class="checkbox-inline mb-2" for="Edit-ServiceSector">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkSerSec" id="ViewSingle-ServiceSector" value="18">
               <label class="checkbox-inline mb-0" for="ViewSingle-ServiceSector">
                 ...
                 <div class="col-12 col-md-6 col-lg-3">
                    <input type="checkbox" name="permission[]" class="checkSerSec" id="Delete-ServiceSector" value="19">
              ...
              <!-- Multiple Checkboxes (inline) -->
              <div class="form-group row mb-5">
                <h5 class="col-sm-12 mb-2 control-label text-lg-left mb-4" for="user">Entreprenuer Questions</h5>
                <div class="col-sm-12"><div class="m-checkbox-inline">
               ...
               <label class="checkbox-inline mb-0" for="checkboxes-0">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkEntAwn" id="Add-Enterpuneer" value="21">
               <label class="checkbox-inline mb-0" for="Add-Enterpuneer">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkEntAwn" id="All-Enterpuneer" value="22">
               <label class="checkbox-inline mb-0" for="All-Enterpuneer">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                  <input type="checkbox" name="permission[]" class="checkEntAwn" id="Edit-Enterpuneer" value="25">
               <label class="checkbox-inline mb-0" for="Edit-Enterpuneer">
                ...
                <div class="col-12 col-md-6 col-lg-3 mb-2">
                   <input type="checkbox" name="permission[]" class="checkEntAwn" id="ViewSingle-Enterpuneer" value="23">
               <label class="checkbox-inline mb-0" for="ViewSingle-Enterpuneer">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkEntAwn" id="AddScore-Enterpuneer" value="27">
               <label class="checkbox-inline mb-0" for="AddScore-Enterpuneer">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkEntAwn" id="Percentage-Enterpuneer" value="nul">
               <label class="checkbox-inline mb-0" for="Percentage-Enterpuneer">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkEntAwn" id="EditScore-Enterpuneer" value="26">
               <label class="checkbox-inline mb-0" for="EditScore-Enterpuneer">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkEntAwn" id="ChangeStatus-Enterpuneer" value="29">
              ...
              <!-- Multiple Checkboxes (inline) -->
              <div class="form-group row mb-5">
                <h5 class="col-sm-12 mb-2 control-label text-lg-left mb-4" for="user">Investor Questions</h5>
                <div class="col-sm-12"><div class="m-checkbox-inline">
               ...
               <label class="checkbox-inline mb-0" for="checkboxes-0">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkInvAwn" id="Add-Investor" value="30">
               <label class="checkbox-inline mb-0" for="Add-Investor">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkInvAwn" id="All-Investor" value="31">
               <label class="checkbox-inline mb-0" for="All-Investor">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                  <input type="checkbox" name="permission[]" class="checkInvAwn" id="Edit-Investor" value="34">
               <label class="checkbox-inline mb-0" for="Edit-Investor">
                ...
                <div class="col-12 col-md-6 col-lg-3 mb-2">
                   <input type="checkbox" name="permission[]" class="checkInvAwn" id="ViewSingle-Investor" value="32">
               <label class="checkbox-inline mb-0" for="ViewSingle-Investor">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkInvAwn" id="AddScore-Investor" value="36">
               ...
               <label class="checkbox-inline mb-0" for="Percentage-Investor">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkInvAwn" id="EditScore-Investor" value="35">
               <label class="checkbox-inline mb-0" for="EditScore-Investor">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkInvAwn" id="ChangeStatus-Investor" value="38">
              ...
              <div class="form-group row mb-5">
                ...
                <div class="row">
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" id="check-allEmail" value="41">
               <label class="checkbox-inline mb-0" for="checkboxes-0">
                         Check All
                  </label> 
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkEmail" id="Add-EmailTemplate" value="40">
               <label class="checkbox-inline mb-0" for="Add-EmailTemplate">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkEmail" id="All-EmailTemplate" value="41">
               <label class="checkbox-inline mb-0" for="All-EmailTemplate">
                ...
                <div class="col-12 col-md-6 col-lg-3 mb-2">
                  <input type="checkbox" name="permission[]" class="checkEmail" id="Edit-EmailTemplate" value="42">
              ...
              <div class="form-group row mb-5">
               ...
               <label class="checkbox-inline mb-0" for="checkboxes-0">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkMemPlan" id="Add-MemberPlan" value="44">
               <label class="checkbox-inline mb-0" for="Add-MemberPlan">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                   <input type="checkbox" name="permission[]" class="checkMemPlan" id="All-MemberPlan" value="45">
               <label class="checkbox-inline mb-0" for="All-MemberPlan">
                ...
                <div class="col-12 col-md-6 col-lg-3 mb-2">
                  <input type="checkbox" name="permission[]" class="checkMemPlan" id="Edit-MemberPlan" value="46">
