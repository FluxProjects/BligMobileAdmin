...
@endsection
@section('content')
<form method="post" action="{{ url("role/group-update/") }}/{{ $role_id }}">
  {{ csrf_field() }}
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body">
            <div class="row">
                <div class="col-4">
                  ...
                  <input type="text" value="{{ $data->group_name }}" class="form-control" name="group_name" placeholder="Group Name">
                </div>
                <div class="col-4">
                  <label>Score:</label>
                  <div class="range-slider">
                    <input class="range-slider__range" name="score" type="range" value="{{ $data->score_weight }}" min="0" max="100">
                ...
                <select class="form-control" name="group_roles[]" multiple="true" style="height: 90px">
                  @foreach( $role as $key => $r )
                    <option {{
                      ...
                      !empty($data->_role_group[$key]) ? 'selected' : ''
          ...
          <div>
            <button type="submit" class="btn btn-dark ml-4 mb-3">Save</button> 
          </div>
        </div>
      </div>
    </div>
