...
var morris_chart = {
    init: function() {
        Morris.Area({
            ...
            xkey: "x",
            ykeys: ["y", "z", "a"],
            barColors: ["#1ea6ec", "#F59500" ,"#ff5370"],
            labels: ["Y", "Z", "A"]
        }), Morris.Bar({
            ...
            Morris.Donut({
                ...
                labelColor: "#999999",
                colors: ["rgba(0, 123, 255, 0.4)", "rgba(30, 166, 236, 0.4)" ,"rgba(68, 102, 242, 0.4)" ,"rgba(255, 83, 112, 0.4)" ,"rgba(0, 123, 255, 0.4)", "rgba(30, 166, 236, 0.4)" ,"rgba(68, 102, 242, 0.4)"],
            ...
            Morris.Bar({
                ...
                ykeys: ["y", "z", "a"],
                labels: ["A", "Y", "Z"],
                barColors: ["#ff9f40", "#1ea6ec" ,"#F59500" ,"#ff5a75" ,"#ff9f40", "#1ea6ec" ,"#F59500"],
                stacked: !0
            });
        });
    }
