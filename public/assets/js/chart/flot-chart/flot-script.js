...
if ($("#flot-basic-chart").length > 0) {
    for (var a = [], b = 0; b < 14; b += .5) a.push([b, Math.sin(b)]);
        ...
        $.plot("#flot-basic-chart", [a, c, d], {
            ...
            colors: ["#ff5a75", "#ff5a75" ,"#ff5a75" ,"#ff5a75"]
        })
}
        ...
        function plotAccordingToChoices() {
            ...
            if (data.length > 0) {
                $.plot("#toggling-series-flot", data, {
                    ...
                    colors: ["#007bff", "#1ea6ec" ,"#F59500" ,"#ff5a75" ,"#007bff", "#1ea6ec" ,"#F59500"]
...
$(function() {
    ...
    var data4_errors = [0.1, 0.4, 0.2];
        ...
        var data = [
            ...
            {color: "#F59500", lines: {show: true}, points: data3_points, data: data3, label: "data3"},
...
$(function() {
    ...
    $.plot('#default-pie-flot-chart', data, {
        ...
        colors: ["#F59500", "#1ea6ec" ,"#22af47" ,"#007bff" ,"#FF5370", "#22af47" ,"#ff9f40"]
    });
